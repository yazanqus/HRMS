        ...
        <div class="container-fluid">
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary ">
                            <h4 class="mt-1 card-text mr-2 text-center"> <a href="{{ route('attendances.approved', ['user'=>$user->first(),'month'=>$attendance->month]) }}">Approve <strong>{{$attendance->month}}</strong> attendance</a> </h4>
                            <h4 class="mt-1 card-text mr-2 text-center"> <a href="{{ route('attendances.declined', ['user'=>$user->first(),'month'=>$attendance->month]) }}">Decline <strong>{{$attendance->month}}</strong> attendance</a> </h4>
