@extends('layouts.app', ['activePage' => 'leaveactivities', 'titlePage' => ('leaveactivities')])
                  ...
                  <div class="container-fluid">
                      <div class="card">
                        <div class="card-header card-header-primary">
                          <h4 class="card-title ">Leaves HR Approval activity log:</h4>
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            @if($activity->properties['old']['status'] == "Pending HR Approval" AND $activity->subject_type == "App\Models\Leave")
