            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div style=" background-color: #ffb678 !important;" class="card-header card-header-primary">
                        ...
                        <h4 class="card-title "> <i class="mr-2 fas fa-search"></i>{{__('advancedSearchuser.balanceexport')}}</h4>
                      </div>
                            ...
                            <div class="row justify-content-center align-items-center h-100">
                              <div class="col-12 col-lg-10 col-xl-10">
                                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                  ...
                                  <form class="form-outline" autocomplete="off" action="{{ route('admin.users.balanceexport') }}" method="POST">
                                      @csrf
