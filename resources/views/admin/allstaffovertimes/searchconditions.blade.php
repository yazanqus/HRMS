                                ...
                                <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                                  ...
                                  <form class="form-outline" autocomplete="off" action="{{ route('admin.overtimes.search') }}" method="POST" target="__blank">
                                      ...
                                      <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }} col-sm-6 flex-column d-flex">
                                        <label class="form-control-label required px-1">{{__('advancedSearchOvertime.staffName')}}</label>
                                      ...
                                      <div class="row justify-content-center">
                                          ...
                                          <div class="form-group col-sm-3"> <a class="btn btn-outline-danger" href="{{route('admin.users.index')}}" >{{__('advancedSearchOvertime.cancel')}}</a> </div>
                                      </div>
                                  </form>
                                  </div>
                                </div>
